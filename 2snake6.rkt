...
(define (next-pit w)
(define snl (pit-snakel w)); primeiro ela separa a snake e os goos do mundo w
(define sn2 (pit-snake2 w)) ; snake2 do mundo
(define goos (pit-goos w))
(define obst (pit-obstacles w))
(define goo-to-eat1 (can-eat snl goos)); eh o goo que a snake 1 come, caso contrario a lista eh vazia
(define next-w (if goo-to-cat1
(pit (grow snl (goo-type goo-to-eat1)) sn2 (age-goo (eat goos goo-to-eatl obst) obst) obst)
(pit (slither snl) sn2 (age-goo goos obst) obst)))
(define next-snl (pit-snakel next-w) ); snakel atualizada
(define next-goos (pit-goos next-w)) ; lista de goos atualizada
(define goo-to-eat2 (can-eat sn2 next-goos))
(if goo-to-eat2
(pit next-snl (grow sn2 (goo-type goo-to-eat2)) (age-goo (eat goos goo-to-eat2 obst) obst) obst)
